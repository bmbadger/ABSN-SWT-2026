...
* **Preisser JS, et al.** Review of small sample corrections for generalized estimating equations in stepped wedge cluster randomized trials. *PCORI Methodology Report (ME-1511-33031).* [https://www.pcori.org/research-results/2016/review-small-sample-corrections-generalized-estimating-equations-stepped-wedge-cluster-randomized-trials](https://www.pcori.org/research-results/2016/review-small-sample-corrections-generalized-estimating-equations-stepped-wedge-cluster-randomized-trials)
* **Ryan MM.** *StepWedgeSurvival: Tools for power analysis and simulation in SW-CRTs with time-to-event outcomes.* GitHub. 2023. [https://github.com/maryryan/survivalSWCRT](https://github.com/maryryan/survivalSWCRT)
